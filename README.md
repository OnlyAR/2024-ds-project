...
>
> 来自[Issue #1](https://github.com/OnlyAR/2024-ds-project/issues/1)的提醒：
>
> 诸如 0x12341234 1e8 0.33f 12345667889034L 都属于应该保留在关键信息流中的内容，而不可直接将其中的 x e f L 等字母视作变量。但是！虽然测试数据中存在这样的数据，但是保证不影响结果。
